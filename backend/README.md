...
## Project Structure
    ...
    ├── testapiautocatalog_125734  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_125734`
...
2. Clone this repo and `cd testapiautocatalog_125734`
